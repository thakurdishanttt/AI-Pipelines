...
contracts and document processing in the Documents Processing Pipeline application.
It serves as a central component that coordinates various document-related operations.
